...
/**
 * A bank contains customers with bank acounts
 */
public class Bank
{
     ...
     * and initializes the bank account.
     ...
     * @return the matching customer, or null of no customer
     */
