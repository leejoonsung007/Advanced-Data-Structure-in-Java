...
//        HandleVehicle.readInputVehicleFile("Assignment2/src/InputVehicle.txt", cars, trucks);
//        HandleVehicle.PrintAllVehicle("Assignment2/src/OutputVehicle.txt", cars, trucks);
